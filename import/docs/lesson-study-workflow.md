...
| **Export** | Copy dialogue, study pack, or AI review bundle for ChatGPT/Claude |
| **AI study plan** | Paste ChatGPT/Claude output after export; saved on the text |
| **Quick add** | Promote **Produce cold** lines to corpus examples in one click |
